...
router.post("/employees/login", controller.loginEmployee);


// Forgot password – send reset email
router.post("/employees/forgot-password", controller.forgotPasswordEmployee);

// Reset password – use token from email
router.post("/employees/reset-password-employee/:token", controller.resetPasswordEmployee);
/* =====================================================
   RESTAURANT INFO
===================================================== */
